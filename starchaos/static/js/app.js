...
-----------------------------------------------------------------------*/
    ...
    $(".table-add").on("click", "i", () => {
        ...
        $(".file-upload-pic").on("change", function() {
            ! function(e) {
                if (e.files && e.files[0]) {
                    var t = new FileReader;
                    t.onload = function(e) {
                        $(".profile-pic-pic").attr("src", e.target.result)
                    }, t.readAsDataURL(e.files[0])
                }
            }(this)
        }),
         $(".upload-button-pic").on("click", function() {
            $(".file-upload-pic").click()
        })
    }),$(document).ready(function() {
        $(".file-upload-bg").on("change", function() {
            ! function(e) {
                if (e.files && e.files[0]) {
                    var t = new FileReader;
                    t.onload = function(e) {
                        $(".profile-pic-bg").attr("src", e.target.result)
                    }, t.readAsDataURL(e.files[0])
                }
            }(this)
        }), $(".upload-button-bg").on("click", function() {
            $(".file-upload-bg").click()
        })
    }), $(function() {
        function e(e) {
            return e / 100 * 360
